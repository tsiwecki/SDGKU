...
//create  3 pets
var pet1= new Pet("Scooby",50,"Male","Great Dane","Brown","Grooming","Shaggy","555-555-5555");
var pet2= new Pet("Tiger",50,"Male","Mixed","Black/Brown","Full Service","Tim","555-555-5556");
var pet2= new Pet("Tweety Bird",70,"Male","Cannary","Yellow","Nail Cut","Bugs Bunny","555-555-5557");
...
var inputColor = documenrt.getElementByID("petColor");
...
function register(){
    console.log(inputName.value,inputAge.value,inputGender.value,inputBreed.value,inputColor.value,inputService.value,inputOwner.value,inputPhone.value);

    // create a generic object and pass the info of the vars
    var thePet = new Pet(inputName.value,inputAge.value,inputGender.value,inputBreed.value,inputColor.value,inputService.value,inputOwner.value,inputPhone.value);
    console.log(thePet);
