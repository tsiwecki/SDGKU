...
//- The user can enter information such as product's name, quantity, price and the program should display the info on the console (If you want to use HTML it would be nice, use your imagination). Use the prompt to get the required information.
//-The system should calculate the final price adding taxes (like in Mexico 16% of taxes).
//*** use the Number() (Use a string for the quantity and price)
...
(function() {
    ...
    function estimateTotal(event) {
        ...
        totalItemPrice = (sneakers * 70 ) + (jersey * 65) + (supple * 20) + (water * 6);
